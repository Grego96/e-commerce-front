    ...
    <div className="nav-home">
      ...
      <ul className="nav-home-items">
        <li className="nav-home-item nav-home-item1">
          <p>Ebikes</p>
          <svg
            className="icon icon--arrow-bottom icon--arrow-bottom1"
            viewBox="0 0 14 8"
            role="presentation"
            fill="none"
          >
        ...
        <li className="nav-home-item nav-home-item2">
          <p>Accessories</p>
          <svg
            className="icon icon--arrow-bottom icon--arrow-bottom2"
            viewBox="0 0 14 8"
            role="presentation"
            fill="none"
          >
        ...
        <li className="nav-home-item nav-home-item3">
          <p>Service & support</p>
          <svg
            className="icon icon--arrow-bottom icon--arrow-bottom3"
            viewBox="0 0 14 8"
            role="presentation"
            fill="none"
          >
        ...
        <li className="nav-home-item nav-home-item4">
          <p>About Rad</p>
          <svg
            className="icon icon--arrow-bottom icon--arrow-bottom4"
            viewBox="0 0 14 8"
            role="presentation"
            fill="none"
          >
      ...
      <div className={showForm ? "login-home login-home-true" : "login-home login-home-false"}>
        <LoginHome />
      </div>
    </div>
  );
